...
![admin:admin Redmine login](./2.png)

![Redmine admin panel](./3.png)
...
![searchsploit results for Redmine 4.1.1](./4.png)
...
![[https://hacktricks.wiki/en/network-services-pentesting/pentesting-postgresql.html](https://hacktricks.wiki/en/network-services-pentesting/pentesting-postgresql.html)](./hacktrick.png)
...
![Hello World response on port 10000](./5.png)
