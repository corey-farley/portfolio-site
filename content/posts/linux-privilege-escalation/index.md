...
![search for the Linux version from Q2](./6.jpg)
...
![download the exploit (the correct one is a .c file, not the .txt one)](./7.jpg)
...
![transfer of exploit onto target machine](./9.jpg)
...
![compilation and exploitation](./10.jpg)
...
![list of files with SUID or GUID bits](./18.jpg)
...
![/usr/bin/base64 /etc/shadow | /usr/bin/base64 -d](./21.jpg)
...
![/usr/bin/base64 /home/ubuntu/flag3.txt | /usr/bin/base64 -d](./23.jpg)
...
![backup.sh opened with Nano](./30.jpg)
...
![Netcat connection to host machine & flag5.txt contents](./31.jpg)
...
![example of the $PATH variable](./34.jpg)
...
![some of the writable folders](./35.jpg)
...
![$PATH after appending /home/murdoch](./36.jpg)
...
![compile the code & set the SUID bits](./43.jpg)
...
![running nfs script and flag7.txt contents](./44.jpg)
