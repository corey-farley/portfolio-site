...
![https://github.com/darsigovrustam/CVE-2019-10149](./4.jpg)

![https://github.com/darsigovrustam/CVE-2019-10149](./5.jpg)
...
![powershell.exe hidden | sort +_time](./10.jpg)
...
![host="DESKTOP-BATMAN.Gotham.City"](./11.jpg)
...
![host="DESKTOP-BATMAN.Gotham.City" Source_Network_Address="10.129.231.10"](./12.jpg)
...
![powershell.exe hidden ComputerName="DESKTOP-BATMAN.Gotham.City" | sort +_time](./13.jpg)
...
![powershell.exe hidden ComputerName="DESKTOP-BATMAN.Gotham.City" | sort +_time](./14.jpg)
...
![Google Gemini](./14.jpg)

Or by searching it on google, here is an example of the impacket-wmiexec structure from another source:

![https://www.crowdstrike.com/en-us/blog/how-to-detect-and-prevent-impackets-wmiexec/](./15.jpg)
...
![1> \\127.0.0.1\ADMIN$\__1741858786.12841 2>&1](./16.jpg)
...
![All of the NtWriteFile contents](./22.jpg)
