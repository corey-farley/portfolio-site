...
![Invite webhook flag gated behind Admin access](./2.png)
...
![The copilot describing its own capabilities](./3.png)
...
![Members page showing maya as admin](./4.png)
...
![Member list query result](./5.png)
...
![Mutation type introspection revealing updateMember](./6.png)
...
![Successful updateMember mutation promoting our account to admin](./7.png)
...
![Member list confirming our account is now admin](./8.png)
...
![Flag successfully captured](./9.png)
