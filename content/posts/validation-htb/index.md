...
![account.php reflecting username](./2.png)
...
![persisted XSS on account.php](./5.png)
...
![Burp scanner SQLi hit on country param](./6.png)
...
![File_priv column identified](./8.png)
...
![File_priv confirmed Y for uhc user](./9.png)
...
![test.txt written to web root](./10.png)
